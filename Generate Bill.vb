...
Public Class Generate_Bill
    ...
    Public Shared bno As Integer

    Private Sub Generate_Bill_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Main.Show()
    End Sub
    Private Sub Generate_Bill_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'ShopManagementDataSet7.Bill' table. You can move, or remove it, as needed.
        ' Me.BillTableAdapter2.Fill(Me.ShopManagementDataSet7.Bill)
        'TODO: This line of code loads data into the 'ShopManagementDataSet5.Bill' table. You can move, or remove it, as needed.
        ' Me.BillTableAdapter1.Fill(Me.ShopManagementDataSet5.Bill)
        'TODO: This line of code loads data into the 'ShopManagementDataSet4.Bill' table. You can move, or remove it, as needed.
        ' Me.BillTableAdapter.Fill(Me.ShopManagementDataSet4.Bill)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        ElseIf Not IsNumeric(TextBox10.Text) Then
            MsgBox("EntTextBox10.Cer the numeric value.", MsgBoxStyle.Critical, "Error")
            TextBox10.Clear()
            TextBox10.Focus()
        ...
        ElseIf Not IsNumeric(TextBox11.Text) Then
            ...
            TextBox11.Focus()
        Else
            Dim qty, price, total As Integer
